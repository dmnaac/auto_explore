...
class FrontierSearch {
   ...
   private:
    ...
    // Get the grid cell index for a given x coordinate in the OccupancyGrid map. getIndexFromX
    ...
    // Get the grid cell index for a given y coordiante in the OccupancyGrid map. getIndexFromY
    ...
    // Get the x coordinate from a given grid cell index in the OccupancyGrid map. getCoordinateFromX
    ...
    // Get the y coordinate from a given grid cell index in the OccupancyGrid map. getCoordinateFromY
